...
<body class="text-center">
    <form class="form-signin" method="post" action="<?php echo site_url('login/entrar'); ?>">
        ...
        <a href="<?php echo site_url('login/cadastro'); ?>">
            <button class="btn btn-lg btn-danger btn-block mt-3" type="button">Nova Conta</button>
        </a>
